...
export default function SearchResult() {
  ...
  <View className="">
       ...
       <View className="overflow-hidden border border-gray-200 bg-white pb-6">
         ...
         {/* btn  */}
         <View className="flex-1 flex-row justify-between gap-1 px-3">
            <Link href="/sitterProfile" asChild>
                <TouchableOpacity className="border py-2 px-6 rounded flex-1 flex-row justify-center items-center">
                    <Text className="text-black font-semibold text-center p-0 m-0">View Profile</Text>
                </TouchableOpacity>
            </Link>
             <TouchableOpacity className="bg-black py-2 px-6 rounded flex-1 flex-row justify-center items-center">
